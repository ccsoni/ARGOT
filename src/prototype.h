...
void assign_ray_segment(struct light_ray*, struct ray_segment*, struct run_param*, struct mpi_param*, struct omp_param*);
void count_ray_segment(struct light_ray*, struct run_param*, struct omp_param*);
void accum_optical_depth(struct light_ray*, struct ray_segment*, struct run_param*, struct omp_param*);
...
#ifdef __GRAVITY__
void fluid_integrate(struct fluid_mesh*, struct run_param*, struct mpi_param*, struct fftw_mpi_param*, float*, float*, float);
void init_fftw_mpi(struct run_param*, struct fftw_mpi_param*, float**);
void init_green(float*, struct run_param*, struct fftw_mpi_param*);
void zero_out_mesh_density(float*, struct fftw_mpi_param*);
void calc_mesh_density(float*, struct fluid_mesh*, struct run_param*, struct fftw_mpi_param*);
void calc_mesh_grav_pot(float*, struct fluid_mesh*, struct run_param*, struct fftw_mpi_param*, float*);
void add_gravity_term(struct fluid_mesh*, struct fluid_mesh*, struct pad_region*, struct pad_region*, struct run_param*, struct mpi_param*, float, int);
#else /* !__GRAVITY__ */
...
void zero_out_photoion_rate_cuda(struct cuda_mem_space*, struct cuda_param*, struct run_param*);
#ifdef __DIFFUSE_RADIATION__
...
void send_run_param_data(struct run_param*, struct cuda_mem_space*, struct cuda_param*);
...
void calc_optical_depth_cuda(struct ray_segment*, struct cuda_mem_space*, struct cuda_param*, struct run_param*);
void calc_photoion_rate_cuda(struct cuda_mem_space*, struct light_ray*, struct light_ray_IO*, struct cuda_param*, struct run_param*);

#ifndef __USE_GPU_ARGOT__
void merge_photoion_data(struct fluid_mesh*, struct cuda_mem_space*, struct cuda_param*, struct run_param*);
#endif
#endif
