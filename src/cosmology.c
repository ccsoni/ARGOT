...
float ddplus(float anow, struct cosmology cosm)
{
  if(anow == 0.0) {
    return 0.0e0;
  }else{
...
float dplus(float anow, struct cosmology cosm)
{
  int it;
  float result;
  float eta, omega_k;
...
int main(void)
{
  ...
  tunit = 3.085629e+17/cosm.hubble;
  znow = 8.8492;
  znow = 0.01;

  tnow = ztotime(znow, cosm);printf("%14.6e\n", tnow*tunit/year);exit(0);

  printf("%16.8e \n", timetoz(tnow + 5.0e4*year/tunit, cosm));
  printf("%16.8e \n", timetoz(tnow + 1.0e5*year/tunit, cosm));
  printf("%16.8e \n", timetoz(tnow + 2.0e5*year/tunit, cosm));
  printf("%16.8e \n", timetoz(tnow + 3.0e5*year/tunit, cosm));
  printf("%16.8e \n", timetoz(tnow + 4.0e5*year/tunit, cosm));
