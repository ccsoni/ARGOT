...
#define eV_to_erg (1.6022e-12)
#define erg_to_eV (6.242e11)
#define nuL       (3.28e15)
#define nuLeV     (13.6)

#define GAMMA_MONOATOMIC (1.66666666666666666)
#define GAMM1_MONOATOMIC (0.66666666666666666)
...
#define HeI_BBT_ENG  (1.45588)  // 19.8/13.6
#define HeI_BBS_ENG  (1.55882)  // 21.2/13.6
#define HeII_BB_ENG  (3.0)      // 40.8/13.6
...
extern double shielding_func_H2(double, double);
extern double shielding_func_HI(double);
