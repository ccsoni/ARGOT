...
#define NNODE_Z (4)
#define NNODE (NNODE_X*NNODE_Y*NNODE_Z)
#define NSEG_PER_RAY (10) /* max. number of segments for a single light ray */
...
#define NCHANNEL_HYDROGEN_MOL (3)
...
#define NMESH_PER_BLOCK_DRT (8)
#define NMESH_PER_BLOCK_DMESH (256)
#define NSEG_MAX_PER_BLOCK (512)
#define NSEG_MAX_PER_DEV (16384)
#elif 1
#define NMAX_CUDA_DEV (4) /* number of CUDA devices per node */
#define NMESH_PER_BLOCK (256)
#define NMESH_PER_BLOCK_DRT (32)
#define NMESH_PER_BLOCK_DMESH (256)
#define NSEG_MAX_PER_BLOCK (512)
#define NSEG_MAX_PER_DEV (32768)
#endif
...
#define NMAX_CUDA_DEV (0) /* dummy */
  ...
  //#define OPENMP_NUMBER_OF_THREADS (20)
#define OPENMP_NUMBER_OF_THREADS (28)
#endif
...
struct run_param {
  ...
  int helium_flag, hydrogen_mol_flag;
  int cosmology_flag;
  int ngrid_nu;
