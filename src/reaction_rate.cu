...
__device__ double k01_dev(double t){
...
__device__ double k02_dev(double t)
{
#ifndef __CASE_B__
  double tev;
...
__device__ double k03_dev(double t)
{
  double tev;
  double logtev, logtev2, logtev3, logtev4, logtev5, logtev6, logtev7, logtev8;
...
__device__ double k04_dev(double t) 
{
#ifndef __CASE_B__
  double tev;
...
__device__ double k05_dev(double t)
{
  double tev;
  double logtev, logtev2, logtev3, logtev4, logtev5, logtev6, logtev7, logtev8;
...
__device__ double k06_dev(double t)
{
#ifndef __CASE_B__
...
__device__ double k07_dev(double t)
{
  double tev;
...
__device__ double k08_dev(double t) 
{
  double tev;
...
__device__ double k09_dev(double t)
{
  if(t > 6.7e+3) {
...
__device__ double k10_dev(double t)
{
  return (6.0e-10);
}

__device__ double k11_dev(double t)
{
  double tev;
...
__device__ double k12_dev(double t)
{
  double tev;
  double logtev, logtev2, logtev3, logtev4, logtev5, logtev6, logtev7, logtev8;
...
__device__ double k13_dev(double t)
{
  return (0.0);
...
__device__ double k14_dev(double t)
{
  double tev;
...
__device__ double k15_dev(double t)
{
  return (0.0);
}

__device__ double k16_dev(double t)
{
  double tev;
  double logtev, logtev2, logtev3, logtev4, logtev5, logtev6, logtev7, logtev8;
...
__device__ double k17_dev(double t)
{
  double tev;
  double logtev,logtev2,logtev3,logtev4,logtev5,logtev6,logtev7,logtev8,logtev9;
...
__device__ double k18_dev(double t)
{
  double tev;
...
__device__ double k19_dev(double t)
{
  if(t>1.0e4) {
...
__device__ double k20_dev(double t)
{
  // double tev;
...
__device__ double k21_dev(double t)
{
  double tev;
