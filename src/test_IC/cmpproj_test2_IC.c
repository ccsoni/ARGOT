...
int main(int argc, char **argv)
{
  ...
  */
  ...
  printf("# density and temperature medium nH = %14.6e, tmpr = %14.6e\n",
	 nH, tmpr);
  printf("# lunit = %14.6e [cm], mlunit = %14.6e [g], tunit = %14.6e [s]\n",
	 this_run.lunit,this_run.munit,this_run.tunit);
  printf("# lunit = %14.6e [mpc], mlunit = %14.6e [M_sun], tunit = %14.6e [myr]\n",
	 this_run.lunit/mpc,this_run.munit/sunmass,this_run.tunit/(1.0e+6*year));
  ...
  printf("# initial fHI = %14.6e, fHII = %14.6e, felec = %14.6e\n",
	 ioneq_chem.fHI, ioneq_chem.fHII, ioneq_chem.felec);

#ifdef __HELIUM__
  ioneq_chem.GammaHeI = 0.0;
  ioneq_chem.GammaHeII = 0.0;

  printf("# initial fHeI = %14.6e, fHeII = %14.6e, fHeIII = %14.6e\n",
	 ioneq_chem.fHeI, ioneq_chem.fHeII, ioneq_chem.fHeIII);
#endif
#ifdef __HYDROGEN_MOL__
  ...
  printf("# initial fH2I = %14.6e, fH2II = %14.6e, fHM = %14.6e\n",
	 ioneq_chem.fH2I, ioneq_chem.fH2II, ioneq_chem.fHM);
#endif
  printf("\n");
