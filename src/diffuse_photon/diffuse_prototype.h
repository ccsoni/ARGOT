...
void calc_diffuse_photon_radiation(struct fluid_mesh*, struct run_param*, struct cuda_mem_space*, struct cuda_param*, struct host_diffuse_param* ,struct cuda_diffuse_param*, struct omp_param*);
#else //!__USE_GPU__
...
void calc_diffuse_photon_radiation(struct fluid_mesh*, struct run_param*, struct host_diffuse_param*, struct omp_param*);
#endif //__USE_GPU__
